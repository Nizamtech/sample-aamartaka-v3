    ...
    <div className="w-full rounded-t-lg bg-white border-2 ">
      <div className="ml-8">
        ...
        <div className="flex justify-between items-center">
          {" "}
          <h1 className="text-xl text-gray-500 ">Profession: Salaried</h1>{" "}
          {/* <h1 className="text-xl text-gray-500">Banani,Dhaka,1230</h1> */}
        </div>
        <hr className="my-3" />
        <div className="grid grid-cols-2 place-items-start  my-8">
          <div>
            <h1 className=" text-gray-500">Company Name</h1>
            <h1 className=" text-slate-800 font-bold">Asha Telecom ltd.</h1>
          </div>
          <div className="flex flex-col justify-start">
            <h1 className=" text-gray-500">Salary</h1>
            <h1 className=" text-slate-800 font-bold">12000 TK</h1>
          </div>
        </div>
        <div className="grid grid-cols-2 place-items-start  my-8">
          <div>
            <h1 className=" text-gray-500">Location</h1>
            <h1 className=" text-slate-800 font-bold">Banani,Dhaka-1230</h1>
          </div>
          <div className="flex flex-col justify-start">
            <h1 className=" text-gray-500">Visit Date </h1>
            <h1 className=" text-slate-800 font-bold"> 2022-06-05</h1>
          </div>
        </div>
        <div className="grid grid-cols-2 place-items-start my-8">
          <div>
            <h1 className=" text-gray-500">Schedule Date </h1>
            <h1 className=" text-slate-800 font-bold">2022-06-19</h1>
          </div>
          <div className="flex flex-col justify-start">
            <h1 className=" text-gray-500">Schedule Time </h1>
            <h1 className=" text-slate-800 font-bold"> 12:00:00 - 14:00:00</h1>
          </div>
        </div>
