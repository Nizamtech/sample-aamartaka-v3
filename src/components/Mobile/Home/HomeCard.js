...
const HomeCard = ({ title, body, color, icon, anm }) => {
  return (
    <div>
      <div
        href="#"
        className="flex flex-col justify-between items-center  p-3 h-20 w-20 max-w-sm min-w-min  bg-white rounded-lg border-gray-200  hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
      >
        {body && (
